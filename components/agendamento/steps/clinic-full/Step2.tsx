...
export const Step2 = ({ professional, selectedCategory, selectedService, onSelectService }: Step2Props) => {
  // Filtrar serviços pela categoria selecionada
  const categoryServices = professional.serviceCategories.find(
  ...
  return (
    <View style={styles.stepContent}>
      ...
      <Text style={styles.sectionTitle}>
        {categoryServices.name}s Disponíveis
      </Text>
